...
func TestToNativeType(t *testing.T) {
	...
	assert.Equal(t, "bit(1)", *ToNativeType(schema.SchemaJsonTablesElemColumnsElem{Type: schema.SchemaJsonTablesElemColumnsElemTypeString, Subtype: util.Ptr(schema.SchemaJsonTablesElemColumnsElemSubtypeBit)}).Postgres)
...
func TestToNativeTypeArray(t *testing.T) {
	...
	assert.Equal(t, "bit(1)[]", *ToNativeType(schema.SchemaJsonTablesElemColumnsElem{IsArray: true, Type: schema.SchemaJsonTablesElemColumnsElemTypeString, Subtype: util.Ptr(schema.SchemaJsonTablesElemColumnsElemSubtypeBit)}).Postgres)
