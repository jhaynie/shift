...
func TestGenerateDefaultNoRows(t *testing.T) {
	...
	res, err := GenerateInfoTables(context.Background(), db)
	assert.NoError(t, err)
	assert.NotNil(t, res)
	assert.Empty(t, res)
...
func TestGenerateWithTableCatalog(t *testing.T) {
	...
	res, err := GenerateInfoTables(context.Background(), db, WithTableCatalog("catalog"))
	assert.NoError(t, err)
	assert.NotNil(t, res)
	assert.Empty(t, res)
	if err := mock.ExpectationsWereMet(); err != nil {
...
func TestGenerateWithTableType(t *testing.T) {
	...
	res, err := GenerateInfoTables(context.Background(), db, WithTableType("type"))
	assert.NoError(t, err)
	assert.NotNil(t, res)
	assert.Empty(t, res)
	if err := mock.ExpectationsWereMet(); err != nil {
...
func TestGenerateWithTableSchemaExcludes(t *testing.T) {
	...
	res, err := GenerateInfoTables(context.Background(), db, WithTableSchemaExcludes([]string{"table"}))
	assert.NoError(t, err)
	assert.NotNil(t, res)
	assert.Empty(t, res)
	if err := mock.ExpectationsWereMet(); err != nil {
